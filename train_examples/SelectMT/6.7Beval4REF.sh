...
DIRA="/workspace/trl-main/trained_checkpoints/GRPO/6.7-ref"
DIRB="/workspace/trl-main/train_examples/SelectMT/all_models_eval_results/6.7-ref"
DATA_PATH="/workspace/trl-main/datasets/test/TestHumanRef.jsonl"
...
for folder in "$DIRA"/checkpoint-*/; do        # 用 */ 匹配所有子目录，不限于 checkpoint-*
