...
JUDGE_C_WEIGHT=${judge_c_weight:-1.0}
RE_EXE_REWARD_WEIGHT=${re_exe_reward_weight:-1.0}
SYNTAX_REWARD_WEIGHT=${syntax_reward_weight:-0.5}
SEMANTIC_REWARD_WEIGHT=${semantic_reward_weight:-0.3}
...
# 动态拼接模型路径 (解决之前的语法错误)
SFT_MODEL_DIR="/workspace/qwen3-train/LLaMA-Factory-main/CIM-${LLM_SIZE}B-FullSFT-fcheckpoints/checkpoint-${LLM_STEP}"
